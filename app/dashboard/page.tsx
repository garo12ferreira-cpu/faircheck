    ...
    >
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        {activeTab === "history" && (
          <div>
            {loadingHistory && (
              <div className="text-center py-16" style={{ color: "#6E7681" }}>Loading audit history...</div>
            )}
            {!loadingHistory && audits.length === 0 && (
              <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
                ...
                <button
                  ...
                  style={{ backgroundColor: "rgba(59,130,246,0.12)", border: "1px solid rgba(59,130,246,0.35)", color: "#60A5FA", cursor: "pointer" }}
                >
                  Run First Audit →
                </button>
              </div>
