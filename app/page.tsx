    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 pt-32 pb-24">
          {/* Badge */}
          <div
            className={`fade-in-up ${isVisible("hero") ? "visible" : ""} inline-flex items-center gap-2 mb-8`}
          >
            <span
          ...
          <p
            ...
            style={{ color: "#8B949E" }}
          >
            FairCheck gives compliance officers a plain-English bias audit report
            in under 10 minutes —{" "}
          ...
          {/* Trust bar */}
          <div
            className={`fade-in-up delay-400 ${isVisible("hero") ? "visible" : ""} mt-16 flex flex-wrap justify-center gap-8`}
          >
      ...
      >
        <div
          className={`fade-in-up ${isVisible("problem") ? "visible" : ""} text-center mb-4`}
        >
          <span
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, #0F1117 0%, rgba(59,130,246,0.04) 50%, #0F1117 100%)",
        }}
      >
        <div className="max-w-6xl mx-auto">
          <div
            className={`fade-in-up ${isVisible("how") ? "visible" : ""} text-center mb-4`}
          >
            <span
              className="pill-badge mb-4"
              style={{
          ...
          <p
            className={`fade-in-up delay-200 ${isVisible("how") ? "visible" : ""} text-center max-w-lg mx-auto mb-16`}
            style={{ color: "#6E7681" }}
          >
            We abstracted away every technical barrier so you can focus on what
              ...
              >
                {i < steps.length - 1 && (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, rgba(59,130,246,0.3), rgba(59,130,246,0.05))",
                      marginLeft: "16px",
                      width: "calc(100% - 32px)",
                    }}
                  />
      ...
      >
        <div
          className={`fade-in-up ${isVisible("who") ? "visible" : ""} text-center mb-4`}
        >
          <span
            className="pill-badge mb-4"
            style={{
        ...
        <div className="max-w-2xl mx-auto">
          <div
            ...
            style={{
              ...
              border: "1px solid rgba(59,130,246,0.2)",
              background:
                "linear-gradient(135deg, #161B22 0%, rgba(59,130,246,0.04) 100%)",
            }}
          >
          ...
          <div className="flex items-center gap-6 mt-2">
            {["Privacy", "Terms", "Contact"].map((link) => (
              <a
                ...
                onMouseLeave={(e) => {
                  (e.target as HTMLAnchorElement).style.color = "#484F58";
                }}
              >
                {link}
              </a>
